...
Work through the conformance requirements in Part 3 of the written
standard for your three classes (`apx-data`, `apx-events`, `apx-control`)
— every MUST in the corresponding Parts applies. Satisfying all of them =
you may claim APX conformance. Check as you complete each step above, not
at the end.
